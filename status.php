...
$configServerAddress = 'play.stone-age.org'; // your server hostname or ip address
$configServerPort = 25592; // your server port
$configServerName = 'Stone age'; // your server name
$configServerWebsite = 'Stone-age.org'; // your server website URL, set to '' if you don't have one
